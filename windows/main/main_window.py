...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabTasks),
                                  QCoreApplication.translate("MainWindow", u"Tasks", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabSchedules),
                                  QCoreApplication.translate("MainWindow", u"Schedules", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabLogs),
