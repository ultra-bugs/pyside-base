...
def createSplash(
    imagePath: str, opacity: float = 1.0, alwaysOnTop: bool = True, autoClose: Optional[int] = None, maxWidthRatio: float = 0.5, maxHeightRatio: float = 0.6
) -> Optional[SplashComponent]:
    """
